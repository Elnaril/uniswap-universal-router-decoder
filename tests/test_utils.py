...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ...
            1,
            1500000001,
        ),  # EIP-1559 went live at block 12965000
    ),
)
def test_compute_gas_fees(
    trx_speed, block_identifier, expected_priority_fee, expected_max_fee_per_gas, w3
):
...
@pytest.mark.parametrize(
    "amount_0_input, amount_1_input", ((Wei(0), Wei(0)), (Wei(0), Wei(1)))
)
...
@pytest.mark.parametrize(
    "amount_0_input, amount_1_input", ((Wei(-1), Wei(1)), (Wei(1), Wei(-1)))
)
