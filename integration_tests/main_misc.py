...
def buy_uni_with_fees():
    ...
    initial_account_balance = uni_contract.functions.balanceOf(
        account.address
    ).call()
    initial_account_2_balance = uni_contract.functions.balanceOf(
        account_2.address
    ).call()
    ...
    account_uni_balance = uni_contract.functions.balanceOf(
        account.address
    ).call()
    account_2_uni_balance = uni_contract.functions.balanceOf(
        account_2.address
    ).call()

    uni_received = (account_uni_balance - initial_account_balance)
    uni_received_account_2 = (
        account_2_uni_balance - initial_account_2_balance
    )

    assert uni_received > 0
    assert uni_received_account_2 > 0
